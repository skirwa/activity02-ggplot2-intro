...
**Response**: A summary of the flipper of each specie is displayed. The summaries are distinct, because of the different colors used.
...
**Response**: In the boxplot the species are clearly distinguished, unlike in the jitterplot. 
The boxplot gives a summary of the flipper length, while the jitterplot shows the individual points.
